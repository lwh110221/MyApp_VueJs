...
<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
      ...
      <router-link
        to="/community"
        class="text-gray-600 hover:text-green-600 transition-colors flex items-center gap-1"
      >
    ...
    <div v-else class="bg-white rounded-lg shadow p-6">
      <form @submit.prevent="submitPost">
          ...
          <div v-if="selectedTags.length > 0" class="mt-3">
            ...
            <div class="flex flex-wrap gap-2">
              <div
                ...
                :key="tag"
                class="bg-green-100 text-green-700 px-2 py-1 rounded-full text-sm flex items-center gap-1"
              >
                {{ tag }}
                <button
                  type="button"
        ...
        <div class="mb-6">
          ...
          <div class="flex items-center gap-2">
            <label
              class="px-4 py-2 bg-green-50 text-green-600 border border-green-200 rounded-lg cursor-pointer hover:bg-green-100 transition-colors flex items-center gap-1"
          ...
          <div v-if="images.length > 0" class="grid grid-cols-3 md:grid-cols-4 gap-4 mt-4">
            <div
              ...
              :key="index"
              class="relative rounded overflow-hidden aspect-square shadow-sm"
            >
              <img
              ...
              <div class="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-20 transition-all flex items-center justify-center">
                <button
                  type="button"
                  class="bg-red-500 text-white rounded-full w-8 h-8 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity shadow-sm"
